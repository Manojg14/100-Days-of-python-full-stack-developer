...
def students_mark_details(student_name):
    if student_name in (student_details and student_maths_mark and student_science_mark and student_english_mark):
        ...
        return f"STUDENT NAME: {student_name},STUDENT AGE: {age},STUDENT MATHS MARK: {math_mark}, STUDENT SCIENCE MARK: {science_mark}, STUDENT ENGLISH MARK: {english_mark}"
